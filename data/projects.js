...
const PROJECTS = [
...

  {
    ...
    title: "Trackplan",
    category: "apps",
    description: "A Flutter app built as company work. Not yet released — full write-up to follow.",
    role: [
      "Sole developer on the project.",
      "Cross-platform build in Flutter.",
    ],
  ...
  },
  {
    ...
    description: "A cooperative 2D multiplayer vocabulary puzzle for mobile, inspired by Codenames — teams race through timed guessing rounds across five competitive rounds. Designed for ages 8+.",
    role: "Game design and Unity development — multiplayer round flow, timers and team scoring.",
    tech: ["Unity", "C#"],
  },
  {
    id: "ez-escape",
